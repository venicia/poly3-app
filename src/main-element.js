...
export class MainElement extends PolymerElement {
    ...
    <app-drawer-layout drawer-width="288px" responsive-width="1280px" narrow="{{narrow}}">
      ...
      <app-header-layout>
        ...
        <iron-pages selected="{{routeData.page}}" attr-for-selected="name" selected-attribute="visible">
          <patient-form name="patient-form" patients="{{patients}}" visible></patient-form>
          <front-desk name="front-desk" patients="{{patients}}"></front-desk>
        </iron-pages>
